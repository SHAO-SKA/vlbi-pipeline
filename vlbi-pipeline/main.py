...
###################################################################
	...
	if pang_flag == 1:
    	...
    	if do_fringe_flag == 1:
            ...
            run_fringecal_1(pr_data, refant, refant_candi, calsource[0], 7, 1, solint, -1, 0,100,100)
            run_fringecal_1(pr_data, refant, refant_candi, p_ref_cal[0], 7, 1, solint, -1, 0,100,100)
        # run_fringecal_1(pr_data,refant, refant_candi, p_ref_cal,7,1,solint,-1,0)
